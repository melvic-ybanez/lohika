...
lazy val root = (project in file("."))
  .settings(
    name := "lohika",
    assembly / assemblyJarName := "lohika-0.5.0-snapshot.jar",
...
lazy val core = (project in file("core"))
  .settings(
    ...
    assembly / assemblyJarName := "lohika-core-0.5.0-snapshot.jar",
    assembly / assemblyMergeStrategy := commonMergeStrategy
  )
...
lazy val ui = (project in file("ui"))
  .settings(
    ...
    assembly / assemblyJarName := "lohika-ui-0.5.0-snapshot.jar",
